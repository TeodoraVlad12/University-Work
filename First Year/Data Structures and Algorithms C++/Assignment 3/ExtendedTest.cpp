...
bool myrelation(TComp r1, TComp r2) {
	return r1 >= r2;
}
...
void testNewFunct() {
	...
	cout << "The new functionality wooooorks"<<endl;
...
void testAllExtended() {
	testCreate();            //ok
	testAdd(relation3);    //ok   
	testAdd(relation3);	    //ok
	testRemove(relation2);   //ok
	testRemove(relation2);
	testIterator(relation2);   //ok   
	testIterator(relation3);   //ok
	testQuantity(relation2);      //ok
	testQuantity(relation3);      //ok
