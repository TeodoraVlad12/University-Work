...
public class Examples {
    ...
    IStatement ex21 = new CompoundStatement(new VariableDeclarationStatement("b", new BoolType()),
            new CompoundStatement(new VariableDeclarationStatement("c", new IntType()),
    ...
    public IStatement[] exampleList(){
        return new IStatement[]{ex1, ex2, ex3, ex4, ex5, ex6, ex7, ex8, ex9, ex10, ex11, ex12, ex13, ex14, ex15, ex16, ex17, ex18, ex19, ex20, ex21};
    }
}
