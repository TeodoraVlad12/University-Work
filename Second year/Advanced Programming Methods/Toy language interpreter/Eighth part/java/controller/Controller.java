...
public class Controller {
    ...
    public void oneStepForAllPrgGUI() throws Exception {
    ...
    public void oneStepForAllPrg(List<ProgramState> programStatesList) throws InterruptedException {
        ...
        //It returns a list of newly created program states (the threads)
        ...
        this.repo.setPrgList(programStatesList);   //we set the new list of program states into the repo
    }
    ...
    public MyIList<Value> getOutGUI() {return this.getAllPrograms().get(0).getOutput();}
    public MyIDictionary<StringValue, BufferedReader> getFileTableGUI() {return this.getAllPrograms().get(0).getFileTable();}
    public MyIHeap<Value> getHeapTableGUI() {return this.getAllPrograms().get(0).getHeap();}
