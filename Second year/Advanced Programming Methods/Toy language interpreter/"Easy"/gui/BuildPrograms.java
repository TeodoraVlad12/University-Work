...
public class BuildPrograms {
    ...
    public static List<IStatement> build()
    {
        ...
        IStatement example5 = new CompoundStatement(new VariableDeclarationStatement("a", new IntType()),
                new CompoundStatement(new VariableDeclarationStatement("b", new IntType()), new CompoundStatement(new AssignmentStatement("a", new ValueExpression(new IntValue(12))),
                        new CompoundStatement(new AssignmentStatement("b", new ValueExpression(new IntValue(15))), new CompoundStatement(new VariableDeclarationStatement("r", new BoolType()),
                                new CompoundStatement(new AssignmentStatement("r", new RelationalExpression(new VariableExpression("a"), new VariableExpression("b"), "<")),
                                        new PrintStatement(new VariableExpression("r")))
                        )))));
        ...
        IStatement example7 = new CompoundStatement(new VariableDeclarationStatement("v", new IntType()),
        ...
        IStatement example10 = new CompoundStatement(new VariableDeclarationStatement("v", new RefType(new IntType())),
                new CompoundStatement(new NewStatement("v", new ValueExpression(new IntValue(20))),
                        new CompoundStatement(new VariableDeclarationStatement("a", new RefType(new RefType(new IntType()))),
                                new CompoundStatement(new NewStatement("a", new VariableExpression("v")),
                                        new CompoundStatement(new NewStatement("v", new ValueExpression(new IntValue(30))),
                                                new CompoundStatement(new PrintStatement(new ReadHeapExpression(new ReadHeapExpression(new VariableExpression("a")))),
        ...
        IStatement example12 = new CompoundStatement(new VariableDeclarationStatement("a", new RefType(new IntType())),
                new CompoundStatement( new VariableDeclarationStatement("counter", new IntType()),
                        new WhileStatement(new RelationalExpression(new VariableExpression("counter"), new ValueExpression(new IntValue(10)), "<"),
                                new CompoundStatement( new ForkStatement(new ForkStatement(new CompoundStatement(new NewStatement("a", new VariableExpression("counter")),
                                        new PrintStatement(new ReadHeapExpression(new VariableExpression("a")))))),new AssignmentStatement("counter", new ArithmeticExpression(new VariableExpression("counter"), new ValueExpression(new IntValue(1)), "+"))
                                )
                        )));

        IStatement example13 =  new CompoundStatement(new VariableDeclarationStatement("a", new BoolType()), new CompoundStatement( new AssignmentStatement("a", new RelationalExpression( new ValueExpression(new IntValue(2)), new ValueExpression(new IntValue(12)),">=")), new PrintStatement(new VariableExpression("a"))));

        IStatement example14 =  new CompoundStatement(new VariableDeclarationStatement("a", new BoolType()), new CompoundStatement( new AssignmentStatement("a", new LogicExpression( new ValueExpression(new BoolValue(false)), new ValueExpression(new BoolValue(true)),"||")), new PrintStatement(new VariableExpression("a"))));



        //for
        IStatement example15 = new ForStatement("i", new ValueExpression(new IntValue(0)), new ValueExpression(new IntValue(5)), new ArithmeticExpression(new VariableExpression("i"), new ValueExpression(new IntValue(1)),"+"), new PrintStatement(new VariableExpression("i")));
...
*/
        ...
        return Arrays.asList(example1, example2, example3, example4, example5, example6, example7, example8, example9, example10, example11, example12,example13,example14,example15,example16,example17,example18,example19,example20,example21,example22,example23,example24,example25);
