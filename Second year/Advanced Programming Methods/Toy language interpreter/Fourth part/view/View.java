...
public class View {
    ...
    public void example1() throws MyException, IOException {
    ...
    public void example2() throws MyException, IOException{
    ...
    public void example3() throws MyException , IOException{
    ...
    public void example4() throws MyException, IOException{
    ...
    public void example5() throws MyException, IOException{
        IStatement ex = new CompoundStatement(new VariableDeclarationStatement("varf", new StringType()),
    ...
    public void runProgram(IStatement stmt) throws MyException, IOException{
        MyIStack<IStatement> exeStack = new MyStack<>();
        MyIDictionary<String, Value> symTable = new MyDictionary<>();
        MyIList<Value> out = new MyList<>();
        MyIDictionary<String, BufferedReader> fileTable = new MyDictionary<>();

        ProgramState state = new ProgramState(exeStack, symTable, out, stmt, fileTable);

        IRepository repo = new Repository(state, "file1.txt");
